...
class L4P1D(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "L4P1D")
        ...
        self._Ac_range = Range(0, 70, 1, 70, 200)
...
def main(top_block_cls=L4P1D, options=None):
